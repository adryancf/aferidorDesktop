function cadastrar() {
    ...
    xmlhttp.open('post','includes/hardwares/cadastrar.php',true);
...
function excluir(id_,obj){
	if(confirm("Deseja realmente excluir este item?")){
		var id = id_;
		//var url = url_;
		xmlhttp.open('post','includes/hardwares/excluir.php',true);
		xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		...
		xmlhttp.send('id_hardware='+id);
	}
}
function excluirsoftfunc(id_,obj){
	if(confirm("Deseja realmente excluir este item?")){
		var id = id_;
		//var url = url_;
		xmlhttp.open('post','includes/softwaresfunc/excluir.php',true);
		xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		xmlhttp.onreadystatechange = function resposta_excluir() {
			if(xmlhttp.readyState == 1 ){
				//document.getElementById("aguarde").innerHTML = '<img src="../../imagens/loading.gif" />';
		...
		xmlhttp.send('id_softwarefunc='+id);
	}
}
