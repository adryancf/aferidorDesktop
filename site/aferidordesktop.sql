...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/04/2024 às 08:14
...
(1, 1, 1, 'Core i3 3,1 Ghz', '16 GB', '2X320 GB', 'NVIDIA GeForce 210', 'Gravador de DVD LG', 'H61M-VS', 'd', '394', '2011-12-01', '2023-07-11'),
...
(1, 'Adryan Castro', '42b02cb5d31014cadd6b1afc647fa390', 'adryan'),
(2, 'teste', 'ae941167ab3d0311373423daa6f1b5bc', 'teste');
...
--
ALTER TABLE `hardwares`
  MODIFY `id_hardware` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `softwaresfunc`
  MODIFY `id_softwarefunc` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
